module.exports = function toReadable(number) {
    return [`zero`, `one`, `two`, `three`, `four`, `five`, `six`, `seven`, `eight`, `nine`, `ten`,
        ...
        `one hundred ninety one`, `one hundred ninety two`, `one hundred ninety three`, `one hundred ninety four`, `one hundred ninety five`, `one hundred ninety six`, `one hundred ninety seven`, `one hundred ninety eight`, `one hundred ninety nine`, `one hundred`,
